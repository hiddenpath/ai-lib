...
async fn test_suggested_actions() {
    ...
    let test_cases = vec![
        (
            AiLibError::RateLimitExceeded("Rate limit".to_string()),
            ErrorType::RateLimit,
        ),
        (
            AiLibError::AuthenticationError("Auth failed".to_string()),
            ErrorType::Authentication,
        ),
        (
            AiLibError::ContextLengthExceeded("Context too long".to_string()),
